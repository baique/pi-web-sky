...
| --- | --- | --- |
| `--port <port>`, `-p <port>` или `PORT` | Порт сервера | `30143` |
...
Сервер разработки доступен по адресу [http://127.0.0.1:30143](http://127.0.0.1:30143). Основные проверки запускаются командами:
