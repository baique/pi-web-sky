...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.timeToday": "Today",
    "sidebar.timeYesterday": "Yesterday",
    "sidebar.timeThisWeek": "This week",
    "sidebar.timeThisMonth": "Last 30 days",
    "sidebar.timeOlder": "Older",
    ...
    "boards.searchPlaceholder": "Search cards, notes, or chat messages…",
    "boards.searchNoResults": "No matching items",
    "boards.searchSession": "Session",
    "boards.searchNote": "Note",
    "boards.searchGroupNodes": "Node hits",
    "boards.searchGroupBody": "Chat hits",
    "boards.searchBodyTag": "Chat",
    ...
    "chat.quoteForkFailed": "Failed to create quoted chat",
    "chat.quoteSelectionToggle": "Show an ask menu after selecting text",
    "chat.sendQuestion": "Send question",
    "chat.imageNotSupportedTitle": "The selected model does not support images",
    "chat.imageNotSupportedBody": "Model {model} accepts text input only; attached images will not be sent. Switch to a vision-capable model or remove the attachments.",
    ...
    "settings.chatContentWidthDescription": "Set the maximum width of message content and the input box.",
    ...
    "settings.chat": "Chat",
    "settings.quoteSelection": "Ask about selected text",
    "settings.resetChatContentWidth": "Reset chat width",
    "settings.resetChatContentFontSize": "Reset chat font size",
    "settings.projectRequired": "Project required",
    "settings.themeLight": "Light",
    "settings.themeDark": "Dark",
    "tools.title": "Tools enabled in the current session",
