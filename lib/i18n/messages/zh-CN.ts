...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.deleteSession": "删除 {title}？此操作不可恢复",
    "sidebar.rename": "重命名",
    "sidebar.pin": "置顶",
    "sidebar.unpin": "取消置顶",
    ...
    "sidebar.boardsTab": "看板",
    "sidebar.filesTab": "文件",
    "sidebar.tasks": "任务",
    "sidebar.tempSessions": "聊天",
    "sidebar.timeToday": "今天",
    "sidebar.timeYesterday": "昨天",
    "sidebar.timeThisWeek": "本周",
    "sidebar.timeThisMonth": "近一月",
    "sidebar.timeOlder": "更久之前",
    "sidebar.newTask": "新建任务…",
    "sidebar.taskName": "任务名称",
    "sidebar.newTaskSession": "新建任务会话",
    "sidebar.loadMoreSessions": "加载更多（{count}）",
    "sidebar.resizeTasks": "拖拽调整任务区高度",
    "sidebar.deleteTask": "删除任务",
    "sidebar.deleteTaskConfirm": "删除任务「{name}」及其下 {count} 个会话？此操作不可恢复",
    "boards.system": "系统",
    "boards.title": "看板",
    ...
    "boards.collapse": "收合",
    "boards.workbenchLimit": "同时只支持展开一个工作台",
    "boards.create": "创建",
    "boards.running": "运行中",
    "boards.runningDesc": "跨项目自动聚合所有运行中的会话",
    "boards.project": "项目",
    "boards.empty": "还没有看板 — 新建一个吧",
    "boards.new": "新建看板…",
    "boards.rename": "改名",
    "boards.delete": "删除",
    "boards.deleting": "删除中…",
    ...
    "boards.cancel": "取消",
    "boards.namePlaceholder": "看板名称",
    "boards.loadingCanvas": "正在加载画布…",
    "boards.runningEmpty": "当前没有运行中的会话 — 运行中的会话会自动出现在这里",
    "boards.emptyCanvas": "空看板 — 从侧栏添加会话（{count} 个节点）",
    "boards.back": "返回",
    "boards.switchBoard": "切换看板",
    "boards.addSession": "添加会话",
    "boards.connect": "连线",
    "boards.connectDesc": "连接两张卡片（先点起点，再点终点）",
    "boards.autoLayout": "自动布局",
    "boards.autoLayoutDesc": "自动布局暂未开放",
    "boards.cleanup": "清理失效",
    "boards.clearDesc": "清空画布（删除所有卡片/便笺/连线）",
    "boards.clearConfirm": "确定清空整张画布？此操作不可撤销。",
    ...
    "boards.noSessions": "没有会话",
    "boards.newSession": "新建会话",
    "boards.draftPlaceholder": "新建会话 — 输入消息开始聊天…",
    "boards.searchPlaceholder": "搜索卡片标题、便笺或聊天正文…",
    "boards.searchNoResults": "没有匹配的节点",
    "boards.searchSession": "会话",
    "boards.searchNote": "便笺",
    "boards.searchGroupNodes": "节点命中",
    "boards.searchGroupBody": "正文命中",
    "boards.searchBodyTag": "正文",
    "search.placeholder": "搜索会话…",
    "search.indexing": "正在建立索引…",
    "search.noResults": "没有匹配的结果",
    "search.empty": "输入关键词搜索会话标题或对话内容",
    "search.title": "标题",
    "search.taskCards": "任务卡",
    "search.sessions": "会话",
    ...
    "chat.taskPlaceholder": "[{task}] - 消息…输入 / 使用命令，输入 @ 查找文件",
    "chat.steer": "引导",
    "chat.followUp": "后续消息",
    "chat.send": "发送",
    ...
    "chat.quoteForkFailed": "无法创建引用对话",
    "chat.quoteSelectionToggle": "选中文字后显示询问菜单",
    "chat.sendQuestion": "发送问题",
    "chat.imageNotSupportedTitle": "当前模型不支持图片",
    "chat.imageNotSupportedBody": "模型 {model} 的输入只支持文本，图片不会被发送。请更换支持图片的模型或移除附件。",
    "chat.attachImage": "附加图片",
    "chat.previewImage": "预览图片",
    "chat.filterModels": "筛选模型…",
    "chat.noMatchingModels": "没有匹配的模型",
    "chat.showModelId": "显示 ID",
    ...
    "settings.chat": "聊天",
    "settings.quoteSelection": "选中文字后询问",
    "settings.resetChatContentWidth": "重置聊天宽度",
    "settings.resetChatContentFontSize": "重置聊天字号",
    "settings.projectRequired": "需要项目",
    "settings.themeLight": "浅色",
    "settings.themeDark": "深色",
    "tools.title": "当前会话启用的工具",
    ...
    "i18n.copy": "复制",
    "i18n.pin": "钉",
    "i18n.pinTitle": "钉住此消息（生成可拖拽/缩放的浮窗）",
    "i18n.copied": "已复制",
    "i18n.cancel": "取消",
    "i18n.save": "保存",
    "i18n.saving": "保存中…",
    ...
    "todo.title": "任务",
    "todo.completed": "已完成",
    "todo.empty": "暂无任务，可以让 agent 添加。",
    "notice.title": "通知",
    "notice.empty": "暂无通知",
    "notice.expand": "展开详情",
    "notice.collapse": "收起",
    "notice.remove": "移除通知",
    "notice.clearAll": "全部清理",
    "terminal.title": "终端",
    "terminal.new": "新建终端",
    "terminal.all": "全部终端",
    "terminal.exited": "已退出",
    "terminal.cleanupDisconnected": "清理失联终端",
